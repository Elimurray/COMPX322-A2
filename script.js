...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('dbconnect.php')
        ...
        .then(data => populateCommoditySelect(data))
    ...
    function CommodityWidget(commodity) {
        ...
        this.render = function() {
            ...
            // Add event listeners
            this.widgetElement.querySelector('.graph-btn').addEventListener('click', () => {
                fetchCommodityData(commodity, false);
            });
            
            this.widgetElement.querySelector('.compare-btn').addEventListener('click', () => {
                fetchCommodityData(commodity, true);
            });
            
            this.widgetElement.querySelector('.remove-btn').addEventListener('click', () => {
